...
export function AgentDocsViewer({ agentId }: AgentDocsViewerProps) {
  ...
  const handleSelectFile = useCallback(
    async (filename: string) => {
      ...
      try {
        const result = await readDocsFile(agentId, filename);
